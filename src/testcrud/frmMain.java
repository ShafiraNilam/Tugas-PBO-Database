...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(10, 10, 960, 70);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(10, 250, 50, 20);

        jLabel8.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel8.setText("Alamat");
        jPanel2.add(jLabel8);
        jLabel8.setBounds(10, 320, 80, 15);
        jPanel2.add(txtAlamat);
        txtAlamat.setBounds(10, 340, 210, 60);
        jPanel2.add(txtNIS);
        ...
        txtEmail.setBounds(10, 270, 120, 30);
        ...
        jPanel2.setBounds(10, 90, 280, 470);
        ...
        jPanel3.setBounds(300, 90, 670, 60);
        ...
        jPanel4.setBounds(300, 160, 670, 400);

        setSize(new java.awt.Dimension(998, 612));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("".equals(txtNIS.getText()) || "".equals(txtAlamat.getText()) || "".equals(txtKelas.getText()) || "".equals(txtNama.getText()) || "".equals(txtEmail.getText())){
            ...
            String SQL = "UPDATE `t_siswa` SET `NIS`="+txtNIS.getText()+",`NamaSiswa`='"+txtNama.getText()+"',`JenisKelamin`='"+JK+"',`Kelas`='"
                    +txtKelas.getText()+"',`Email`='"+txtEmail.getText()+"' WHERE `NIS`="+txtNIS.getText();
            int status = KoneksiDB.execute(SQL);
            if (status == 0) {
